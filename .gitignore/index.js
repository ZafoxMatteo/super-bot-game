...
var rand = ['Oui', 'Non', 'Surmement', 'Je pense', 'Pas du tout', 'Surement pas', 'Ouais'];
...
client.destroy()
client.login(process.env.TOKEN)
message.channel.send(":gear: Reload in Fini !")
} else {
...
client.on(`message`, message => {
    ...
    if(message.content === prefix + "help"){
        ...
        .addField("Commandes de modérations : :rotating_light:", "!kick, !ban, !clear, !reboot, !warns, !mute, !unmute")
